...
#undef QOP_CLOVER_DEFAULT_PRECISION_SAVE__
#if   QOP_CLOVER_DEFAULT_PRECISION=='F'
# define QOP_CLOVER_DEFAULT_PRECISION_SAVE__ 'F'
#elif QOP_CLOVER_DEFAULT_PRECISION=='D'
# define QOP_CLOVER_DEFAULT_PRECISION_SAVE__ 'D'
#endif
...
# undef VectorFermionX
# undef ProjectedFermionX
#if   QOP_CLOVER_DEFAULT_PRECISION_SAVE__=='D'
# define QOP_CLOVER_DEFAULT_PRECISION 'D'
# define qx(x) qd(x)
# define QX(x) QD(x)
# define REAL double
...
# define VectorFermionX VectorFermionD
# define ProjectedFermionX ProjectedFermionD
#elif QOP_CLOVER_DEFAULT_PRECISION_SAVE__=='F'
# define QOP_CLOVER_DEFAULT_PRECISION 'F'
# define qx(x) qf(x)
# define QX(x) QF(x)
# define REAL float
