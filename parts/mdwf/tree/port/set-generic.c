...
static struct qf(ABops) qf(real_ops) = {
  qf(omp_do_A),
  qf(omp_do_A_conj),
  qf(omp_do_A_inverse),
  qf(omp_do_A_conj_inverse),
  qf(omp_do_ApF),
  qf(omp_do_ApF_norm),
  qf(omp_do_AxpBxFx),
  qf(omp_do_BA1),
  qf(omp_do_BA1F),
  qf(omp_do_1mBA1F),
  qf(omp_do_1mBA1F_norm),
  qf(omp_do_A1xBx),
  qf(omp_do_A1xBxFx),
  qf(omp_do_K),
  qf(omp_do_K),
  qf(omp_do_BA1K),
  qf(omp_do_1mK1xA1xBxFx),
  qf(omp_do_1mK1xA1xBxFx_norm),
  qf(omp_do_1mKF),
  qf(omp_do_1mKF_norm)
};

static struct qd(ABops) qd(real_ops) = {
  qd(omp_do_A),
  qd(omp_do_A_conj),
  qd(omp_do_A_inverse),
  qd(omp_do_A_conj_inverse),
  qd(omp_do_ApF),
  qd(omp_do_ApF_norm),
  qd(omp_do_AxpBxFx),
  qd(omp_do_BA1),
  qd(omp_do_BA1F),
  qd(omp_do_1mBA1F),
  qd(omp_do_1mBA1F_norm),
  qd(omp_do_A1xBx),
  qd(omp_do_A1xBxFx),
  qd(omp_do_K),
  qd(omp_do_K),
  qd(omp_do_BA1K),
  qd(omp_do_1mK1xA1xBxFx),
  qd(omp_do_1mK1xA1xBxFx_norm),
  qd(omp_do_1mKF),
  qd(omp_do_1mKF_norm)
};
...
#define w_b(j) (b_5[j])
#define ikap(j)   (2 * w_a(j))
#define kap(j)    (1./ikap(j))
