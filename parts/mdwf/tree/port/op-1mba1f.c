...
void
qx(op_1mBA1F)(struct Fermion *r_x,
	      ...
	      long long *received)
{
    ...
    if (xy->body_size)
      *flops += (params->qx(op)->z1mBA1F)(params->state, r_x, 0, xy->body_size, Ls,
    ...
    *flops += (params->qx(op)->z1mBA1F)(params->state, r_x, xy->body_size, xy->face_size, Ls,
					params->BpTable, params->BmTable,
					params->AipTable, params->AimTable,
