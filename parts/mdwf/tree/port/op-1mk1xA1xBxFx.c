#include <mdwf.h>
void
qx(op_1mK1xA1xBxFx)(struct Fermion *r_x,
                    ...
                    long long *received)
{
    ...
    if (xy->body_size)
      *flops += (params->qx(op)->z1mK1xA1xBxFx)(params->state, r_x, 0, xy->body_size, Ls,
						params->KiTable,
    ...
    *flops += (params->qx(op)->z1mK1xA1xBxFx)(params->state, r_x, xy->body_size, xy->face_size, Ls,
					      params->KiTable,
					      params->AxipTable, params->AximTable,
					      params->BxpTable, params->BxmTable,
